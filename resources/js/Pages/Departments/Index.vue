...
const confirmDeletion = (department) => {
    Swal.fire({
        title: 'Tem certeza?',
        text: `Você está prestes a excluir o departamento "${department.name}". Esta ação não pode ser desfeita.`,
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            router.delete(route('departments.destroy', department.id), {
                ...
                onSuccess: () => {
                    Swal.fire({
                        title: 'Excluído!',
                        text: 'O departamento foi excluído com sucesso.',
                        icon: 'success',
                        confirmButtonColor: '#1e3a8a',
                    });
                },
        ...
        <div class="space-y-6">
            ...
            <div class="sm:flex sm:items-center sm:justify-between bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-2 text-sm text-gray-500">Gerencie seus departamentos de forma simples e eficiente.</p>
                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 px-6 py-4 text-sm items-center">
                                ...
                                <div class="text-right">
                                    <div class="inline-flex items-center gap-3">
                                        ...
                                        <button 
                                            @click="confirmDeletion(department)"
